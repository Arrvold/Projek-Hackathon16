    ...
    <>
      <section className="relative min-h-[800px] flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          {/* 1. Opacity diubah ke bg-white/30 dan ditambahkan border */}
          <div className="bg-white/20 p-20 rounded-2xl border border-black backdrop-blur-sm">
            {/* 2. Class opacity-100 dihapus karena tidak lagi diperlukan */}
            ...
            <p className="text-xl text-gray-800 mb-6 max-w-3xl mx-auto leading-relaxed font-minecraft">
              Jelajahi dunia fantasi yang penuh petualangan, tantangan, dan misteri. 
              Pilih peranmu, kembangkan karaktermu, dan buktikan bahwa kamu adalah 
              pahlawan sejati dalam game RPG terbaik.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button 
                ...
                onMouseDown={(e) => {
                  ...
                  if (img) img.src = '/assets/button_pressed.png';
                }}
                onMouseUp={(e) => {
                  const img = e.currentTarget.querySelector('img');
                  if (img) img.src = '/assets/button.png';
                }}
                onMouseLeave={(e) => {
                  const img = e.currentTarget.querySelector('img');
                  if (img) img.src = '/assets/button.png';
